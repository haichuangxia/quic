...
//接收窗口更新为receive_window_size_limit
 else {
...
//更新发送窗口偏移量
//当发送窗口增加导致blocked状态变为unblocked,返回true,其余情况返回false.
...
//在没有接收任何数据之前receive_window_size = receive_window_offset
